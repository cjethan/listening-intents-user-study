  ...
  return (
    <div className="p-8 bg-gray-50 min-h-screen flex flex-col items-center justify-center">
      <div className="bg-white shadow-lg rounded-lg p-8 max-w-3xl w-full">
        ...
        <p className="mb-6 text-lg leading-relaxed text-gray-700">
          Your data will only be used for scientific research purposes. Participation is entirely voluntary. You are free to withdraw your participation. If you send an email to <a href="mailto:caroline.jethan@gmail.com" className="text-blue-600 underline">caroline.jethan@gmail.com</a>, we will remove your data.
        </p>
        <p className="mb-6 text-lg leading-relaxed text-gray-700">
